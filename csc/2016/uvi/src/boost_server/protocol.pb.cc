...
namespace communication {
    ...
    namespace {
        ...
        struct Task_ParamOneofInstance {
            ...
            ::google::protobuf::int32 dependenttaskid_;
    ...
    void protobuf_AddDesc_protocol_2eproto() {
        ...
        ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
                "\n\016protocol.proto\022\rcommunication\"p\n\016Wrapp"
                        ...
                        "bmitTaskResponse\022\027\n\017submittedTaskId\030\001 \001("
...
// ===================================================================
    ...
    void Task_Param::InitAsDefaultInstance() {
        ...
        Task_Param_default_oneof_instance_->dependenttaskid_ = 0;
    }
        ...
        for (;;) {
            ...
            switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
                ...
                case 1: {
                    ...
                    // optional int32 dependentTaskId = 2;
                case 2: {
                    if (tag == 16) {
...
#undef DO_
    ...
    void Task_Param::SerializeWithCachedSizes(
        ...
        if (has_dependenttaskid()) {
            ::google::protobuf::internal::WireFormatLite::WriteInt32(2, this->dependenttaskid(), output);
        }
    ...
    ::google::protobuf::uint8* Task_Param::SerializeWithCachedSizesToArray(
        ...
        // optional int32 dependentTaskId = 2;
        if (has_dependenttaskid()) {
            target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(2, this->dependenttaskid(), target);
        }
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
        ...
        for (;;) {
            ...
            if (!p.second) goto handle_unusual;
            switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
                // optional int32 submittedTaskId = 1;
                case 1: {
                    if (tag == 8) {
                        DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                                ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
