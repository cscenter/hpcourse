...
// -------------------------------------------------------------------
    ...
    public:
        ...
        inline ::google::protobuf::int32 dependenttaskid() const;
        inline void set_dependenttaskid(::google::protobuf::int32 value);
...
// optional int32 dependentTaskId = 2;
    ...
    inline void Task_Param::clear_dependenttaskid() {
        if (has_dependenttaskid()) {
            param_value_.dependenttaskid_ = 0;
            clear_has_param_value();
        }
    }
    inline ::google::protobuf::int32 Task_Param::dependenttaskid() const {
        if (has_dependenttaskid()) {
            return param_value_.dependenttaskid_;
        }
        return 0;
    }
    inline void Task_Param::set_dependenttaskid(::google::protobuf::int32 value) {
        if (!has_dependenttaskid()) {
            clear_param_value();
